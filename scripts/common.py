...
DOMAIN_UPPER = "ENTERPRISE_RISK"
MCP_SERVER_DIR = "enterprise-risk-mcp-server"
MCP_SERVER_NAME = "企业风险分析洞察"
REPORT_BANNER = "企业风险分析报告"
REPORT_TYPE = "enterprise_risk_analysis"
